...
def parse_args():
    ...
    parser.add_argument('--prefix', dest='prefix', help='prefix of model name', nargs="+",
                        default=[
                                ...
                                #'/home/dafu/workspace/FaceDetect/tf_JDAP/models/pnet/pnet_wider_OHEM_0.7_wop_relu6/pnet',
    ...
    parser.add_argument('--thresh', dest='thresh', help='list of thresh for pnet, rnet, onet', nargs="+",
                        default=[0.4, 0.3, 0.1], type=float)
...
if __name__ == '__main__':
    ...
    print(args)
    output_file = '/home/dafu/workspace/FaceDetect/tf_JDAP/evaluation/mnet/mnet_OHEM_0.7_wop_add_gt_all_relu6_16_0.1.txt'
    output = False
