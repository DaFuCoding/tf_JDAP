...
python ./train/train_auxiliary.py \
    ...
    --logdir="./logdirs/${STAGE_NAME}/${STAGE_NAME}_wider_OHEM_0.7_wop_pnet_300WLP_landmark51_0.13w" \
    --loss_type='SF' \
    --is_ohem=True \
    --is_ERC=False \
    --model_prefix="./models/${STAGE_NAME}/${STAGE_NAME}_wider_OHEM_0.7_wop_pnet_300WLP_landmark51_0.13w/${STAGE_NAME}" \
